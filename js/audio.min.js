...
(function (h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            css: '        .audiojs audio { position: absolute; left: -1px; }         .audiojs { width: 100%; background:  rgba(0,0,0,0);}         .audiojs .play-pause { position:relative; width: 44px; line-height: 44px; margin: 0 auto; padding-bottom:15px;}         .audiojs p { display: none; width: 44px; height: 44px; cursor: pointer; }         .audiojs .play { display: block;}         .audiojs .scrubber { position: relative; margin:0 auto; width: 75%; height: 4px; padding:2px 0px; overflow: hidden; }         .audiojs .progress { position: absolute; top: 0px; left: 0px; height: 4px; width: 0px; background: rgba(0,255,255,0.5); z-index: 1; }      .audiojs .time { position:relative; margin:0 auto; width:30%; height: 40px; line-height: 40px; color: #fff; font-size:22px; text-align:center; padding-bottom: 5px;}         .audiojs .time em { padding: 0px 2px 0px 0px; font-style: normal;}       .audiojs .time strong { padding: 0px 0px 0px 2px; font-weight: normal; }        .audiojs .loaded { position: absolute; top: 0px; left: 0px; height: 4px; width: 0px; background: rgba(0,255,0,0.4);}         .audiojs .error-message { float: left; display: none; margin: 0px 10px; height: 36px; width: 400px; overflow: hidden; line-height: 36px; white-space: nowrap; color: rgba(0,255,0,0.7);           text-overflow: ellipsis; -o-text-overflow: ellipsis; -icab-text-overflow: ellipsis; -khtml-text-overflow: ellipsis; -moz-text-overflow: ellipsis; -webkit-text-overflow: ellipsis; }         .audiojs .error-message a { color: #eee; text-decoration: none; padding-bottom: 1px; border-bottom: 1px solid #999; white-space: wrap; }                 .audiojs .play { background: url("img/music_off.png") no-repeat; }         .audiojs .loading { background: url("$1") -2px -31px no-repeat; }         .audiojs .error { background: url("$1") -2px -61px no-repeat; }         .audiojs .pause { background: url("img/music_on.png") no-repeat; }                 .playing .play, .playing .loading, .playing .error { display: none; }         .playing .pause { display: block; }                 .loading .play, .loading .pause, .loading .error { display: none; }         .loading .loading { display: block; }                 .error .time, .error .play, .error .pause, .error .scrubber, .error .loading { display: none; }         .error .error { display: block; }         .error .play-pause p { cursor: auto; }         .error .error-message { display: block; }',
            trackEnded: function () {
            },
            flashError: function () {
